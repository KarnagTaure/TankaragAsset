...
namespace ProjectoTank
{
    ...
    /// </remarks>
    public class NumeracionJugador : MonoBehaviourPunCallbacks
    {
        ...
        /// </summary>
        public static NumeracionJugador instance;
        ...
        {
            PhotonNetwork.LocalPlayer.CustomProperties.Remove(NumeracionJugador.RoomPlayerIndexedProp);
        }
        ...
        {
            if (changedProps != null && changedProps.ContainsKey(NumeracionJugador.RoomPlayerIndexedProp))
            {
                this.RefreshData();
            }
        }
    ...
    public static class PlayerNumberingExtensions
    {
        ...
        public static int GetPlayerNumber(this Player player)
        {
            ...
            object value;
            if (player.CustomProperties.TryGetValue(NumeracionJugador.RoomPlayerIndexedProp, out value))
            {
                return (byte)value;
            }
            return -1;
        ...
        public static void SetPlayerNumber(this Player player, int playerNumber)
        {
            ...
            if (current != playerNumber)
            {
                ...
                player.SetCustomProperties(new Hashtable() { { NumeracionJugador.RoomPlayerIndexedProp, (byte)playerNumber } });
            }
        }
    }
}
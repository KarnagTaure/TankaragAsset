...
namespace Photon.Pun.Demo.Asteroids
{
    public class LobbyMainPanel : MonoBehaviourPunCallbacks
    {
        ...
        [Header("Crear panel de habitación")]
        ...
        private void UpdateCachedRoomList(List<RoomInfo> roomList)
        {
            ...
            {
                // Eliminar la sala de la lista de salas en caché si se cerró, se volvió invisible o se marcó como eliminada
                ...
                // Actualizar la información de la habitación en caché
                if (cachedRoomList.ContainsKey(info.Name))
                {
                    cachedRoomList[info.Name] = info;
                }
                // Agregar nueva información de la habitación al caché
                else
                {
